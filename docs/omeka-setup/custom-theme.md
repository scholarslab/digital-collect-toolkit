...
- **Navigation Text Color**: Determines the color of the text in the sections listed above. The color of the navigation links in the footer, and the Omeka login links in top admin bar, are set to be a shade darker than the color given here, and show full brightness when you hover over these links. For instructions on how to customize your site's navigation, see [here]({{ site.baseurl }}/docs/omeka-setup/omeka-admin#customizing-site-navigation)
...
<img src="{{ site.url }}{{ site.baseurl }}/assets/images/theme-setting-banner.png" alt="Screen shot of Theme Configuration page" width="600rem"/>
...
|:-------------|:------------------|
| Homepage Banner Background & Introduction Text | ![Screen shot of public homepage banner]({{ site.url }}{{ site.baseurl }}/assets/images/banner-1.png) |
| Introduction Text only | ![Screen shot of public homepage banner]({{ site.url }}{{ site.baseurl }}/assets/images/banner-2.png) |
...
This theme's homepage content can be created with up to four content boxes. The first two are designed for use with a Contribution page (your-site-url/contribution) and an 'About' page (your-site-url/about), created with the [Simple Pages]({{ site.baseurl }}/docs/omeka-setup/omeka-plugins#simple-pages) plugin. If you do not want to use these content boxes with pre-defined footer links, leave sections *Homepage Content Box #1: About the Archive* and *Homepage Content Box #2: Donate Materials* empty, and these will not appear on your site. 
...
| Omeka Admin | Public Site |
|:-------------|:------------------|
| ![Screen shot of Omeka Admin theme content]({{ site.url }}{{ site.baseurl }}/assets/images/theme-content-1.png) | ![Screen shot of public site content]({{ site.url }}{{ site.baseurl }}/assets/images/content-3.png) |
| ![Screen shot of Omeka Admin theme content]({{ site.url }}{{ site.baseurl }}/assets/images/theme-content-2.png) | ![Screen shot of public site content]({{ site.url }}{{ site.baseurl }}/assets/images/content-1.png) |
...
| HTML | Public Site |
|:------------------|:------------------|
| `<h2>About the Archive</h2><p>Recognizing the significance of events on the weekend of August 12, the University of Virginia Library is building an archive of materials surrounding the “Unite the Right” rally and counter-protests.</p>` | ![Screen shot of public site content]({{ site.url }}{{ site.baseurl }}/assets/images/content-3.png) |
...
| Omeka Admin | Public Site |
|:-------------|:------------------|
| ![Screen shot of Theme Configuration page]({{ site.url }}{{ site.baseurl }}/assets/images/theme-contrib-4.png) | ![Screen shot of public site content]({{ site.url }}{{ site.baseurl }}/assets/images/content-5.png) |
...
| Omeka Admin | Public Site |
|:-------------|:------------------|
| ![Screen shot of Theme Configuration page]({{ site.url }}{{ site.baseurl }}/assets/images/theme-contrib-5.png) | ![Screen shot of public site content]({{ site.url }}{{ site.baseurl }}/assets/images/content-6.png) |
